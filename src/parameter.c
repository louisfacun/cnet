...
{   
    /* Initialize parameters based on given layer dimensions.
    
    Parameters:
        layers: (array|int) Number of activation units per layer. 
        l: (int) Number of layers including input, hiddens, and output.
